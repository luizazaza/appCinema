...
<table class="table table-dark table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <button type="button" class="btn-geral" data-bs-toggle="modal" data-bs-target="#modalAlterarFil-{{$dadosfilme->id}}"> Alterar</button>
      </td>
      <td>
      <button type="button" class="btn-geral" data-bs-toggle="modal" data-bs-target="#modalDeleteFil-{{$dadosfilme->id}}">
        Excluir
      </button>
      </td>
    </tr>
